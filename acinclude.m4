...
# paper size, the variable DOXYGEN_TAGFILES may be specified to reference
# additional tagfile locations.
#
...
# Additional tagfile locations
AC_ARG_VAR(DOXYGEN_TAGFILES,
           [additional tagfile locations (see doxygen docu)])
DX_ENV_APPEND(TAGFILES, $DOXYGEN_TAGFILES)
